"""
Implementación del heap de Fibonacci por @danielborowski.
https://github.com/danielborowski/fibonacci-heap-python/blob/master/fib-heap.py
Modificación por Rubén Ballester Bautista
"""
...
class FibonacciHeap:
    ...
    #return  true if heap is empty or false if heap have at least one element
    ...
    # insert new node into the unordered root list in O(1) time. Returns a reference to the new node
